...
const Nav = () => {
    ...
    return (
        <div className={style.containerNav}>
            {
                isMobile && <motion.div className={style.containerMenu}>
                    <GiHamburgerMenu className={style.buttonBurger} onClick={openMenuHandler} />
                </motion.div>
            }
            {
                <div className={style.nav}>
                    ...
                    >
                        <motion.div className={style.back}>
                            {isMobile
                                ? <Link to='/landing'
                                    className={style.backLandingButton}
                                    
                                >Salir</Link>
                                : <motion.div className={style.containerIconBack} initial={{ x: 0 }}
                                    animate={{ x: [0, -5, 0] }}
                                    transition={{ duration: 2, repeat: Infinity, repeatType: 'reverse' }}
                                    onClick={backPage}><BiArrowFromRight className={style.iconBack} /></motion.div>
                            }
                        </motion.div>
                    </motion.div>
                    <motion.div
